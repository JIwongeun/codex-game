...
export const GAMEPLAY = {
  ...
  logHitboxHeight: 18,
  logHitboxMinWidth: 92,
  logHitboxMaxWidth: 176,
  reviewHitboxMinWidth: 124,
  reviewHitboxMaxWidth: 190,
  reviewHitboxHeight: 22,
  fragmentHitboxWidth: 56,
  fragmentHitboxHeight: 18,
  maxProjectiles: 48,
  maxHazards: 4,
  maxSequences: 4,
  logFirstSpawnMs: 850,
