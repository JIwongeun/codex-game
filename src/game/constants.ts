...
export const GAMEPLAY = {
  ...
  logHitboxHeight: 26,
  logHitboxMinWidth: 110,
  logHitboxMaxWidth: 202,
  reviewHitboxMinWidth: 160,
  reviewHitboxMaxWidth: 230,
  reviewHitboxHeight: 38,
  fragmentHitboxWidth: 72,
  fragmentHitboxHeight: 24,
  maxProjectiles: 48,
  maxHazards: 4,
  maxSequences: 4,
  logFirstSpawnMs: 850,
