...
- Services: local storage와 Web Audio 효과음·procedural BGM. BGM sequencer는 game elapsed time의 16분음표 step에만 반응해 같은 frame step을 중복 재생하지 않으며, mute·game over·blur·hidden에서 active music gain을 즉시 disconnect한다. leaderboard HTTP는 실제 구현 시에만 추가
